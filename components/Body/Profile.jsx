                  ...
                  <ul>
                    <li>
                      <div className="item">
                        ...
                        <h3 className="title">{userDetails?.name || "Update"}
                        </h3>
                      </div>
                    </li>
                    <li>
                      <div className="item">
                        ...
                        <h3 className="title">{userDetails?.userName || "Update"}
                        </h3>
                      </div>
                    </li>
                    <li>
                      <div className="item">
                        ...
                        <h3 className="title">{shortenAddress(userDetails?.walletAddress) || "Update"}
                        </h3>
                      </div>
                    </li>
                  </ul>
